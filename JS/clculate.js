    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="text-center">
                <img src="${product.image || 'default-image.jpg'}" alt="${product.descraption}" class="img-responsive center-block" style="max-height: 200px; margin-bottom: 10px;">
            </div>
            <h4 class="text-center" id="productPrice-${key}">${totalProductPrice}₪</h4>
            <div class="text-center">
                <div class="btn-group">
        ...
        <div class="panel-footer text-center" style="background-color: #f5f5f5;">
