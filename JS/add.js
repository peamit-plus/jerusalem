const productsDB = {
  ...
  },
  {
      "id": "1241",
      "image": "tp2",
      "descraption": "תבניות קטנות בתפזורת",
      "price": "0.7 "
  },
  {
      "id": "1240",
  ...
  },
  {
      "id": "1033",
      "image": "k2",
      "descraption": "מארז 3 מיכלי אחסון 2 קג'",
      "price": "7.5 "
  },
  {
      "id": "1034",
  ...
  },
  {
      "id": "104",
      "image": "90",
      "descraption": "מגבונים לחים (72)",
      "price": "2.5 "
  },
  {
      "id": "105",
      "image": "91",
      "descraption": "מגבונים לחים עבים (72)",
      "price": "3.5 "
  },
  {
      "id": "106",
...
function addToLocalStorage(productId) 
{
  ...
  if (product) 
  {
      ...
      showMessage("<div class='' style='font-size:20px;'> <span class='glyphicon glyphicon-ok-circle text-primary' style='font-size:45px;'></span><br/>  המוצר "+"<span class='text-primary'><b>"+ product.descraption+"</b></span>"+" נוסף לסל הקניות <br/> בסיום ההזמנה יהיה ניתן לשנות כמויות וצבע</div>");
