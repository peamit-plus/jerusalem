       ...
       <figure>
          ...
          <figcaption>
            <div class='caption product-caption'>
              <p class='text-center'>
                  <b>${element.p}</b><br/>
                  <button class='btn btn-info' id="addToCartBtn" onclick='addToLocalStorage(${element.productId})'><span class="glyphicon glyphicon-shopping-cart"></span> הוסף לסל</button>
              </p>
            </div>
          </figcaption>
        </figure>
...
function page3() {
  var json = [
    { "productId": "17", "image": "17", "p": "לפתן צבעוני (*25) 2.50₪", "price": "" },
...
function page6() {
  var json = [
    ...
    { "productId": "1018", "image": "nc4", "p": "נייר כסף ארוך עבה (45 מ')37₪", "price": "" },
    ...
    { "productId": "1019", "image": "t1", "p": " תבניות קטן ארוז 7₪", "price": "" },
    { "productId": "1020", "image": "t2", "p": " תבניות קטן עמוק ארוז 7₪", "price": "" },
    { "productId": "1021", "image": "t3", "p": " 7₪ ארוז A4 תבניות בינוני ", "price": "" },
    { "productId": "1022", "image": "t4", "p": " תבניות גדול ארוז 7₪", "price": "" },
    { "productId": "1234561", "image": "", "p": "תבנית ענק לתנור ארוז 7₪", "price": "" },
...
function page11() {
  ...
  { "productId": "123454", "image": "tahliv_1", "p": "תחליב - פינוק קלאסי 11₪", "price": "" },
  { "productId": "123455", "image": "tahliv_2", "p": "תחליב- שיק תפוח ותות 11₪", "price": "" },
  { "productId": "123456", "image": "tahliv_3", "p": "תחליב- שיק אפרסק ומנגו 11₪", "price": "" },
  { "productId": "123457", "image": "tahliv_4", "p": "תחליב -שמן קוקוס 11₪", "price": "" },
  { "productId": "123458", "image": "tahliv_5", "p": "תחליב - שיק פירות יער 11₪", "price": "" },
  { "productId": "123459", "image": "shampo_1", "p": "שמפו 2 ב-1 12₪", "price": "" },
  ]
  generateGallery(json)
}
